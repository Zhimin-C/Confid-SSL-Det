...
MAX_NUM_POINT = 50000
# OUTPUT_FOLDER = './scannet/scannet_train_detection_data'
OUTPUT_FOLDER = 'scannet_train_detection_data'

X_RANGE = [-6., 6.] # (-left, right) in metres
Y_RANGE = [-9., 9.] # (-behind, front) in metres
RESOLUTION = 0.01 #Desired resolution in metres to use. Each output pixel will represent an square region res x res in size
# INITIALIZE EMPTY ARRAY - of the dimensions we want
BOUND_X = [int(X_RANGE[0]/RESOLUTION), int(X_RANGE[1]/RESOLUTION)]
BOUND_Y = [int(Y_RANGE[0]/RESOLUTION), int(Y_RANGE[1]/RESOLUTION)]
GIRD_SIZE = [BOUND_X[1]-BOUND_X[0], BOUND_Y[1]-BOUND_Y[0]]
